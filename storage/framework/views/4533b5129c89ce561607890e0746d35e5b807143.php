...
<?php endif; ?>
                <?php endif; ?>
                <form action="<?php echo e(url('/app-admin/spp/' . encrypt($spp->id_spp))); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="tahun_pertama" id="tahun_pertama" placeholder="tahun pertama" value="<?php echo e(old('tahun_pertama') ? old('tahun_pertama') : $tahun_pertama); ?>" autocomplete="off" min="1000" max="9999">
...
unset($__errorArgs, $__bag); ?>" name="tahun_kedua" id="tahun_kedua" placeholder="tahun kedua" value="<?php echo e(old('tahun_kedua') ? old('tahun_kedua') : $tahun_kedua); ?>" autocomplete="off" min="1000" max="9999">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nominal') ? old('nominal') : $spp->nominal); ?>" placeholder="nominal spp" autocomplete="off" id="nominal">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Widxy Kiyowo\Music\aplikasi-pembayaran-spp\resources\views/admin/pages/spp/edit.blade.php ENDPATH**/ ?>