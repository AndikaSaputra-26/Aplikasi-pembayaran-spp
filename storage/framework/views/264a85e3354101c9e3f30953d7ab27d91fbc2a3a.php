...
<?php endif; ?>
                <?php endif; ?>
                <form action="<?php echo e(url('/app-admin/siswa/' . encrypt($siswa->nisn))); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nama') ? old('nama') : $siswa->nama); ?>" placeholder="nama siswa" autocomplete="off" id="nama">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nisn') ? old('nisn') : $siswa->nisn); ?>" placeholder="nisn" autocomplete="off" id="nisn">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nis') ? old('nis') : $siswa->nis); ?>" placeholder="nis" autocomplete="off" id="nis">
                        ...
                        <select class="js-example-basic-single" name="jenis_kelamin" required="">
                          <?php $__currentLoopData = $jenis_kelamins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis_kelamin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($jenis_kelamin); ?>"
                                ...
                                <?php else: ?>
                                    <?php echo e($jenis_kelamin == $siswa->jenis_kelamin ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('no_telp') ? old('no_telp') : $siswa->no_telp); ?>" placeholder="no telp" autocomplete="off" id="no_telp">
...
unset($__errorArgs, $__bag); ?>" style="height: 100px" placeholder="alamat"><?php echo e(old('alamat') ? old('alamat') : $siswa->alamat); ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select class="js-example-basic-single" name="id_kelas" required="">
                          <?php $__currentLoopData = $kelass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e(encrypt($kelas->id_kelas)); ?>"
                                <?php if( old(encrypt('id_kelas')) ): ?>
                                    <?php echo e(old(encrypt('id_kelas')) == $kelas->id_kelas ? 'selected' : ''); ?>

                                <?php else: ?>
                                    <?php echo e($kelas->id_kelas == $siswa->id_kelas ? 'selected' : ''); ?>

                                <?php endif; ?>
                             ><?php echo e($kelas->nama_kelas); ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <hr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Widxy Kiyowo\Music\aplikasi-pembayaran-spp\resources\views/admin/pages/siswa/edit.blade.php ENDPATH**/ ?>