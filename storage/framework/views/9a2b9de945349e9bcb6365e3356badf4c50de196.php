...
<?php endif; ?>
                <?php endif; ?>
                <form action="<?php echo e(url('/app-admin/kelas/' . encrypt($kelas->id_kelas))); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nama_kelas') ? old('nama_kelas') : $kelas->nama_kelas); ?>" placeholder="nama kelas" autocomplete="off">
                        ...
                        <select class="js-example-basic-single" name="id_kompetensi_keahlian" required="">
                          <?php $__currentLoopData = $kompetensi_keahlian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kompetensi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e(encrypt($kompetensi->id_kompetensi_keahlian)); ?>"
                                ...
                                <?php else: ?>
                                    <?php echo e($kelas->id_kompetensi_keahlian == $kompetensi->id_kompetensi_keahlian ? 'selected' : ''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Widxy Kiyowo\Music\aplikasi-pembayaran-spp\resources\views/admin/pages/kelas/edit.blade.php ENDPATH**/ ?>